...
from .deepeval_gates import DeepEvalGateConfig, run_deepeval_gates
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-tiny-chunk-pct", type=float, default=12.0)
    parser.add_argument("--max-duplicate-instance-pct", type=float, default=0.0)
    parser.add_argument("--max-overlap-p95-chars", type=int, default=50)
